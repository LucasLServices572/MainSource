...
local EspLibrary = loadstring(game:HttpGet("https://pastebin.com/raw/CypsKDab"))()
...
-- Libraries
getgenv().Libraries = loadstring(game:HttpGet("https://pastebin.com/raw/uSK8PuDf"))()
